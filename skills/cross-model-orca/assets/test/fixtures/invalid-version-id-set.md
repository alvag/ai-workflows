# Verification contract — cobertura-inestable
...
| ID | Requirement | Evidence | Command/observation | Expected | Baseline |
|---|---|---|---|---|---|
| v2 | AC-1 | test | node --test dos.test.mjs | suite verde | RED |

### Baseline

- v2: revision `def5678` · 2026-07-22T11:00:00Z · resultado: 1 fallo
