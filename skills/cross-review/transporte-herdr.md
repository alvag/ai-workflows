...
artefacto, fuera del scratch. **La cosecha es por archivo, nunca por lectura del pane:** los agentes
de terminal pintan sobre la pantalla alternativa, las filas que salen del viewport no entran al
scrollback del host y subir el tope de líneas no las recupera, así que un veredicto largo con muchos
findings es irrecuperable desde ahí.
