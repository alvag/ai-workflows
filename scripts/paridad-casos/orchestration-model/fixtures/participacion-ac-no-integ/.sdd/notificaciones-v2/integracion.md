...
| V-C1 | C1 — correr el flujo end-to-end con los dos servicios desplegados [AC-3, AC-4, AC-7] | manual | desplegar los dos servicios y publicar una notificación | el receptor procesa el evento y responde 200 | RED |
