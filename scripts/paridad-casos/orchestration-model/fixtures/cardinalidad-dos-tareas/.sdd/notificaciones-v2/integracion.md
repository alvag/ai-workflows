...
| V-X1 | X1 — archivar el acuerdo del evento en la wiki del equipo [AC-3] | inspección | `grep -c acuerdo wiki.md` | el acuerdo quedó archivado en la wiki | NOT_APPLICABLE |
