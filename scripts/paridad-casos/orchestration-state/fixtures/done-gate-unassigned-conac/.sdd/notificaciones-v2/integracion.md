...
|---|---|---|---|---|---|
| V-G1 | G1 — acordar el esquema del evento entre los dos equipos [AC-3] | inspección | `grep -c "^evento:" acuerdo.md` | el acuerdo declara el esquema del evento | NOT_APPLICABLE |
| V-C1 | C1 — correr el flujo end-to-end con los dos servicios desplegados [AC-4] | manual | desplegar los dos servicios y publicar una notificación | el receptor procesa el evento y responde 200 | RED |
