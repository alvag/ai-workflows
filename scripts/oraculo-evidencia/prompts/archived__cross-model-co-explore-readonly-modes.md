...
- especificación: `.plans/archived/cross-model-co-explore-readonly-modes/spec.md`
- plan: `.plans/archived/cross-model-co-explore-readonly-modes/plan.md`
- tareas: `.plans/archived/cross-model-co-explore-readonly-modes/tasks.md`
...
```
{
  "flujo": "archived/cross-model-co-explore-readonly-modes",
  "tareas": [
    {
