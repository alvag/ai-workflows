...
- especificación: `.plans/archived/herdr-native-sdd-contract-audit/spec.md`
- plan: `.plans/archived/herdr-native-sdd-contract-audit/plan.md`
- tareas: `.plans/archived/herdr-native-sdd-contract-audit/tasks.md`
...
```
{
  "flujo": "archived/herdr-native-sdd-contract-audit",
  "tareas": [
    {
