...
- especificación: `.plans/archived/cross-model-co-explore-investigate-runtime/spec.md`
- plan: `.plans/archived/cross-model-co-explore-investigate-runtime/plan.md`
- tareas: `.plans/archived/cross-model-co-explore-investigate-runtime/tasks.md`
...
```
{
  "flujo": "archived/cross-model-co-explore-investigate-runtime",
  "tareas": [
    {
