...
- especificación: `.plans/archived/sdd1-run-manifest/spec.md`
- plan: `.plans/archived/sdd1-run-manifest/plan.md`
- tareas: `.plans/archived/sdd1-run-manifest/tasks.md`
...
```
{
  "flujo": "archived/sdd1-run-manifest",
  "tareas": [
    {
