...
- especificación: `.plans/archived/cross-model-cross-review-runtime/spec.md`
- plan: `.plans/archived/cross-model-cross-review-runtime/plan.md`
- tareas: `.plans/archived/cross-model-cross-review-runtime/tasks.md`
...
```
{
  "flujo": "archived/cross-model-cross-review-runtime",
  "tareas": [
    {
