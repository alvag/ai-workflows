...
- especificación: `.plans/archived/cross-model-herdr-adapter/spec.md`
- plan: `.plans/archived/cross-model-herdr-adapter/plan.md`
- tareas: `.plans/archived/cross-model-herdr-adapter/tasks.md`
...
```
{
  "flujo": "archived/cross-model-herdr-adapter",
  "tareas": [
    {
