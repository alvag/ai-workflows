...
- especificación: `.plans/archived/retirar-transporte-panes/spec.md`
- plan: `.plans/archived/retirar-transporte-panes/plan.md`
- tareas: `.plans/archived/retirar-transporte-panes/tasks.md`
...
```
{
  "flujo": "archived/retirar-transporte-panes",
  "tareas": [
    {
