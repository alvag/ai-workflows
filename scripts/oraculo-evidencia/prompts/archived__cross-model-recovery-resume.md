...
- especificación: `.plans/archived/cross-model-recovery-resume/spec.md`
- plan: `.plans/archived/cross-model-recovery-resume/plan.md`
- tareas: `.plans/archived/cross-model-recovery-resume/tasks.md`
...
```
{
  "flujo": "archived/cross-model-recovery-resume",
  "tareas": [
    {
