...
- especificación: `.plans/archived/planned-desambiguacion/spec.md`
- plan: `.plans/archived/planned-desambiguacion/plan.md`
- tareas: `.plans/archived/planned-desambiguacion/tasks.md`
...
```
{
  "flujo": "archived/planned-desambiguacion",
  "tareas": [
    {
