...
- especificación: `.plans/archived/instrumento-y-baseline/spec.md`
- plan: `.plans/archived/instrumento-y-baseline/plan.md`
- tareas: `.plans/archived/instrumento-y-baseline/tasks.md`
...
```
{
  "flujo": "archived/instrumento-y-baseline",
  "tareas": [
    {
