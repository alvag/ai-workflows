...
- especificación: `.plans/archived/cross-model-codex-adapter/spec.md`
- plan: `.plans/archived/cross-model-codex-adapter/plan.md`
- tareas: `.plans/archived/cross-model-codex-adapter/tasks.md`
...
```
{
  "flujo": "archived/cross-model-codex-adapter",
  "tareas": [
    {
