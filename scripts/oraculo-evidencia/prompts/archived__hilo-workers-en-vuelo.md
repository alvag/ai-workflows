...
- especificación: `.plans/archived/hilo-workers-en-vuelo/spec.md`
- plan: `.plans/archived/hilo-workers-en-vuelo/plan.md`
- tareas: `.plans/archived/hilo-workers-en-vuelo/tasks.md`
...
```
{
  "flujo": "archived/hilo-workers-en-vuelo",
  "tareas": [
    {
