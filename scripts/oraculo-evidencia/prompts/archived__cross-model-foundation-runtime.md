...
- especificación: `.plans/archived/cross-model-foundation-runtime/spec.md`
- plan: `.plans/archived/cross-model-foundation-runtime/plan.md`
- tareas: `.plans/archived/cross-model-foundation-runtime/tasks.md`
...
```
{
  "flujo": "archived/cross-model-foundation-runtime",
  "tareas": [
    {
