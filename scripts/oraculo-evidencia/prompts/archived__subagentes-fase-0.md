...
- especificación: `.plans/archived/subagentes-fase-0/spec.md`
- plan: `.plans/archived/subagentes-fase-0/plan.md`
- tareas: `.plans/archived/subagentes-fase-0/tasks.md`
...
```
{
  "flujo": "archived/subagentes-fase-0",
  "tareas": [
    {
