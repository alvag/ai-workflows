...
- especificación: `.plans/archived/cross-model-fanout-synthesis/spec.md`
- plan: `.plans/archived/cross-model-fanout-synthesis/plan.md`
- tareas: `.plans/archived/cross-model-fanout-synthesis/tasks.md`
...
```
{
  "flujo": "archived/cross-model-fanout-synthesis",
  "tareas": [
    {
