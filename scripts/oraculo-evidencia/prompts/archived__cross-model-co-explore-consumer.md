...
- especificación: `.plans/archived/cross-model-co-explore-consumer/spec.md`
- plan: `.plans/archived/cross-model-co-explore-consumer/plan.md`
- tareas: `.plans/archived/cross-model-co-explore-consumer/tasks.md`
...
```
{
  "flujo": "archived/cross-model-co-explore-consumer",
  "tareas": [
    {
