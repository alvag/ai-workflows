...
- especificación: `.plans/archived/paridad-powershell/spec.md`
- plan: `.plans/archived/paridad-powershell/plan.md`
- tareas: `.plans/archived/paridad-powershell/tasks.md`
...
```
{
  "flujo": "archived/paridad-powershell",
  "tareas": [
    {
