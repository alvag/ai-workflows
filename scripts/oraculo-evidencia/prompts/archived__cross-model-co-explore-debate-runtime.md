...
- especificación: `.plans/archived/cross-model-co-explore-debate-runtime/spec.md`
- plan: `.plans/archived/cross-model-co-explore-debate-runtime/plan.md`
- tareas: `.plans/archived/cross-model-co-explore-debate-runtime/tasks.md`
...
```
{
  "flujo": "archived/cross-model-co-explore-debate-runtime",
  "tareas": [
    {
