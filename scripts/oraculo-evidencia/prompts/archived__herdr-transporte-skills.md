...
- especificación: `.plans/archived/herdr-transporte-skills/spec.md`
- plan: `.plans/archived/herdr-transporte-skills/plan.md`
- tareas: `.plans/archived/herdr-transporte-skills/tasks.md`
...
```
{
  "flujo": "archived/herdr-transporte-skills",
  "tareas": [
    {
