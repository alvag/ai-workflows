...
- especificación: `.plans/archived/matriz-y-contrato/spec.md`
- plan: `.plans/archived/matriz-y-contrato/plan.md`
- tareas: `.plans/archived/matriz-y-contrato/tasks.md`
...
```
{
  "flujo": "archived/matriz-y-contrato",
  "tareas": [
    {
