...
test('la tabla de banderas cubre exactamente los seis verbos', () => {
...
test('ninguna fila hereda banderas de la cadena de prototipos', () => {
  for (const verbo of VERBS) {
...
test('cada bandera declara su forma, y solo esas dos', () => {
  for (const verbo of VERBS) {
